...
SECRET_KEY = 'django-insecure-7fx8qnr3j+f9b9$l$jtwhr8$zp%f%63ha(a2cfcxxy1#53=han'
...
CORS_ALLOW_ALL_ORIGINS = True  # Allow all origins for CORS (for development purposes)
